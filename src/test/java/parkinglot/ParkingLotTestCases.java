...
public class ParkingLotTestCases {
    ...
    public void whenDriverParkHisCar_SpaceTokenShouldReturnTrue() {
        ...
        HashMap<Integer, Boolean> integerBooleanHashMap1 = parkingLot.addedInfo(car1);
        HashMap<Integer, Boolean> integerBooleanHashMap2 = parkingLot.addedInfo(car2);
        HashMap<Integer, Boolean> integerBooleanHashMap3 = parkingLot.addedInfo(car3);
        HashMap<Integer, Boolean> integerBooleanHashMap4 = parkingLot.addedInfo(car4);
        HashMap<Integer, Boolean> integerBooleanHashMap5 = parkingLot.addedInfo(car5);
